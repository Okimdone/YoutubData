...
(   comment_id VARCHAR2(12)    CONSTRAINT co_id_PK PRIMARY KEY
...
(   comments_id VARCHAR2(12)    CONSTRAINT cv_co_id_FK REFERENCES comments(comment_id) ON DELETE CASCADE
...
CREATE TABLE Comment_reponse
(   comments_id  VARCHAR2(12)       CONSTRAINT cr_co_id_FK REFERENCES comments(comment_id) ON DELETE CASCADE
,   comments_id_Parent VARCHAR2(12) CONSTRAINT cr_co_p_id_FK REFERENCES comments(comment_id) ON DELETE CASCADE 
