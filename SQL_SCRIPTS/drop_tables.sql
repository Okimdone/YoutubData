...
ALTER TABLE Comments_video DISABLE CONSTRAINT cv_co_id_FK;
ALTER TABLE Comments_video DISABLE CONSTRAINT cv_v_id_FK;
ALTER TABLE Comments_reponse DISABLE CONSTRAINT cr_co_id_FK;
ALTER TABLE Comments_reponse DISABLE CONSTRAINT cr_co_p_id_FK;


drop table Comments_reponse;
